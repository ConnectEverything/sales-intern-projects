...
class StreamImpl {
    ...
    info(cached = false) {
        ...
        return this.api.info(this.name).then((si)=>{
            this._info = si;
            return this._info;
        });
    }
